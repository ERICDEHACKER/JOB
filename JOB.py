...
#AUTHOR : CHIGOZIEWORLDWIDE (JOB)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO JOB
...
header = {"user-agent": '[Mozilla/5.0 (Linux; Android 4.4.4; XT1053 Build/KXA21.12-L1.29.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.93 Mobile Safari/537.36;]',
